...
function Palette({ t, showLabels, categoryMode, app, onClose, initialQuery = '', initialMode = 'fuzzy', initialSelected = 0 }) {
  const [query, setQuery] = React.useState(initialQuery);
  const [mode, setMode] = React.useState(initialMode); // fuzzy | semantic
